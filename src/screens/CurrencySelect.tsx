...
const currencies = [
  { name: 'Dolar Estadounidense', code: '$', symbol: 'USD', imageSource: require('../assets/images/flagUsa.png') },
  { name: 'Euro', code: '€', symbol: 'EUR', imageSource: require('../assets/images/flagRounded.png') },
  { name: 'Libra Esterlina', code: '£', symbol: 'GBP', imageSource: require('../assets/images/flagUk.png') },
];
