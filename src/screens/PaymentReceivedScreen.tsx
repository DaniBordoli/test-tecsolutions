  ...
  return (
    <Container>
      ...
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: '50%', }}>
        ...
        <Text style={{ color: '#002859', fontSize: 20, marginTop: 10, fontWeight: 'bold' }}>Pago recibido</Text>
        <Text style={{ color: 'grey', fontSize: 16, marginTop: 16 }}>El pago se ha confirmado con éxito</Text>
      </View>
      <Overlay />
